...
export default function Achievements() {
  ...
  return (
    <>
      <button
        type="button"
        className="achievement-launcher"
      ...
      <style jsx>{`
        ...
        .achievement-launcher span { font-size: 18px; }
        ...
        .achievement-toast {
          ...
          animation: achievementIn .35s cubic-bezier(.16,1,.3,1);
        }
        ...
        .achievement-toast span { display: block; }
        ...
        @media (max-width: 600px) {
          .achievement-progress { left: 10px; bottom: 10px; font-size: 8px; }
          .achievement-launcher { right: 10px; bottom: 10px; padding: 8px 10px; }
        }
      `}</style>
    </>
  );
